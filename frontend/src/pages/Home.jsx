...
const Home = () => {
  ...
  const resolutionRate = Math.round((totalResolved / (totalResolved + totalOpen)) * 100);
    ...
    <div className="bg-gray-900 min-h-screen font-sans text-white overflow-hidden">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 to-indigo-900 py-48 shadow-2xl overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20 animate-bg-pulse">
            <svg className="w-full h-full" viewBox="0 0 1440 320">
                <path fill="#4f46e5" fillOpacity="0.5" d="M0,64L48,80C96,96,192,128,288,128C384,128,480,96,576,90.7C672,85,768,107,864,122.7C960,139,1056,149,1152,144C1248,139,1344,117,1392,106.7L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
            </svg>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center transform translate-y-[-1rem] animate-fadeInDown">
          ...
          <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto font-light text-indigo-200">
            **Charting a course for civic repair.** Your voice is the compass, guiding our city's journey to a better future.
          </p>
          <Link
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 transform rotate-[-10deg]" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 15l-5-5h10l-5 5z"/></svg>
          </Link>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-800 border-t-8 border-yellow-500/50">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-extrabold text-center mb-12 text-white">The City Pulse: Real-Time Impact</h2>
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="p-8 bg-blue-800 rounded-3xl shadow-xl border-b-4 border-green-400 text-center transform hover:scale-[1.05] transition duration-300 animate-slideInLeft">
              <p className="text-4xl font-black text-green-400">{totalResolved}</p>
            ...
            <div className="p-8 bg-blue-800 rounded-3xl shadow-xl border-b-4 border-red-400 text-center transform hover:scale-[1.05] transition duration-300 animate-slideInUp">
              ...
              <p className="text-lg text-indigo-200 mt-2">Tickets Awaiting Crew</p>
            </div>
            {/* Card 3: Rate */}
            <div className="p-8 bg-blue-800 rounded-3xl shadow-xl border-b-4 border-yellow-400 text-center transform hover:scale-[1.05] transition duration-300 animate-slideInUp">
              <p className="text-4xl font-black text-yellow-400">{resolutionRate}%</p>
              <p className="text-lg text-indigo-200 mt-2">Current Resolution Rate</p>
            </div>
            ...
            <div className="p-8 bg-blue-800 rounded-3xl shadow-xl border-b-4 border-purple-400 text-center transform hover:scale-[1.05] transition duration-300 animate-slideInRight">
              <p className="text-4xl font-black text-purple-400">{totalSubmissionsToday}</p>
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 text-white border-b-2 border-yellow-500 pb-3">The Compass Points: Key Features</h2>
          <div className="grid lg:grid-cols-3 gap-12">
            {[
              ...
              >
                <div className="text-6xl mb-4 transition-transform duration-500 group-hover:rotate-[10deg]">{feature.icon}</div>
                <h3 className="text-2xl font-bold mb-3 text-yellow-400">{feature.title}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
            {complaints && complaints.length > 0 ? (
              ...
              <div className="col-span-full text-center py-10 bg-gray-800 rounded-xl shadow-inner border border-gray-700">
                ...
                <Link to="/submit" className="mt-4 inline-block text-yellow-500 hover:text-yellow-400 font-bold transition duration-300">
      ...
      <section className="py-20 bg-indigo-800 border-t-8 border-indigo-900">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-extrabold text-white mb-4">Ready to embark?</h2>
          <p className="text-xl text-indigo-200 mb-10 max-w-2xl mx-auto">
            Your credentials are your ticket to ride. Find your place in The Caravan Chronicle today.
          </p>
