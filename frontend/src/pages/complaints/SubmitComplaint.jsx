...
export default function SubmitComplaint() {
    ...
    const handleGetLocation = () => {
        ...
        toast.loading("Fetching your current location...", { id: 'location-fetch' });
    ...
    useEffect(() => {
        ...
        mapRef.current.addControl(new maptilersdk.NavigationControl({ visual: false }), "top-left");
    ...
    useEffect(() => {
        ...
        if (location.lat != null && location.lng != null) {
            if (!markerRef.current) {
                markerRef.current = new maptilersdk.Marker({ draggable: true, color: '#ff4444' })
                    .setLngLat(lngLat)
    ...
    const handleSubmit = async (e) => {
        ...
        if (!title.trim() || !description.trim() || photos.length === 0) {
            toast.error("Please provide a title, description, and at least one photo.");
            return;
        }
        ...
        try {
            ...
            toast.success("✅ Complaint submitted successfully! Thank you for reporting.");
            resetForm();
        } catch (err) {
    ...
    return (
        <Box
            ...
            mb={5}
            px={2}
            className="bg-gray-50" // Light background for contrast
        >
            <Card sx={{ maxWidth: 800, width: "100%", p: 4, boxShadow: 10, borderRadius: 3 }}>
                <CardContent>
                    <Typography 
                        variant="h4" 
                        gutterBottom 
                        ...
                        <Stack spacing={4}>
                            ...
                            <Box sx={{ border: '1px dashed #bdbdbd', p: 2, borderRadius: 2 }}>
                                ...
                                <Typography variant="caption" display="block" color="text.secondary">
                                    Maximum 5 images allowed. Photos help us understand the issue better.
                                </Typography>
                            ...
                            <Box
                                ...
                                sx={{
                                  ...
                                  width: "100%",
                                    position:'relative',
                                    borderRadius: 2,
                                    border: `2px solid ${location.lat != null ? '#1976d2' : '#ddd'}`,
                                    overflow: "hidden",
                                    cursor: "crosshair",
                            ...
                            >
                                **Tip:** Click on the map to place the marker, or drag the red marker to precisely locate the issue.
                            </Typography>
                            ...
                            >
                                ...
                                <Typography variant="subtitle1">
                                    {location.lat != null && location.lng != null
                                        ? `Selected Coordinates: Lat ${location.lat.toFixed(6)}, Lng ${location.lng.toFixed(6)}`
